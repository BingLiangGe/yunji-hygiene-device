...
import com.yunji.hygiene.entity.domain.req.jt808.LogOutMsg;
...
@Slf4j
@Component(HandleConstant.LOG_OUT_SERVICE)
@ChannelHandler.Sharable
public class LogOutMsgHandler extends AbsChannelReadHandler<LogOutMsg> {
